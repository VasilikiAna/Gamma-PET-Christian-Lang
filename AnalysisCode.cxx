...
bool ExternalAnalysisPipelineExample::Analyze()
{
  ...
  double ScatterMin = 3.1,ScatterMax = 4.0, AbsorberMin = 6.0, AbsorberMax = 12.0;
  /*
...
///////////////////////////
  for (unsigned int h = 0; h < SimEvent->GetNHTs(); ++h) {
   ...
   if (REHit->GetPositionZ() > ScatterMin && REHit->GetPositionZ() < ScatterMax && FlagRechts == 1 && REHit->GetEnergy() > 0.0) {
   ...
   if (REHit->GetPositionZ() > ScatterMin && REHit->GetPositionZ() < ScatterMax && FlagRechts == 0 && REHit->GetEnergy() > 0.0) {
    //cout << " Treffer RECHTS " << endl;
   FlagRechts = 1;
   ...
   if (REHit->GetPositionZ() < (ScatterMin * -1) && REHit->GetPositionZ() > (ScatterMax * -1) && FlagLinks == 1 &&REHit->GetEnergy() > 0.0) {
   ...
   if (REHit->GetPositionZ() < (ScatterMin * -1) && REHit->GetPositionZ() > (ScatterMax * -1) && FlagLinks == 0 &&REHit->GetEnergy() > 0.0) {
   // cout << " Treffer LINKS " << endl;
    FlagLinks = 1;
   ...
   if (REHit->GetPositionX() > ScatterMin && REHit->GetPositionX() < ScatterMax && FlagOben == 1 && REHit->GetEnergy()> 0.0) {
   ...
   if (REHit->GetPositionX() > ScatterMin && REHit->GetPositionX() < ScatterMax && FlagOben == 0 && REHit->GetEnergy() > 0.0) {
   //cout << " Treffer OBEN " << endl;
    FlagOben = 1;
   ...
   if (REHit->GetPositionX() < (ScatterMin * -1) && REHit->GetPositionX() > (ScatterMax * -1) && FlagUnten == 1 &&REHit->GetEnergy() > 0.0) {
   ...
   if (REHit->GetPositionX() < (ScatterMin * -1) && REHit->GetPositionX() > (ScatterMax * -1) && FlagUnten == 0 &&REHit->GetEnergy() > 0.0) {
    //cout << " Treffer UNTEN " << endl;
    FlagUnten = 1;
